...
import (
	...
	ketiv1 "k8s.io/client-go/kubernetes/typed/keti/v1"
...
func (c *Clientset) KetiV1() ketiv1.KetiV1Interface {
	return c.ketiV1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.ketiV1, err = ketiv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.ketiV1 = ketiv1.NewForConfigOrDie(c)
